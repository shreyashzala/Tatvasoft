...
<?php 
   ...
   include("./includes/sp-ajax/new-request-ajax.php");
                ...
                <div class="card">
                    <div class="card-text">
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active demo1" href="#">New Service Request</a>
                            <a class="nav-link demo2" href="sp_upcoming_service.php">Upcoming Services</a>
            ...
            <div class="col-md-6 col-sm-6 col-6">
                ...
                <table class="table">
                    <thead>
                        ...
                        <th>Time Conflict<img src="./assets/image/sort.png" alt=""></th>
                        <th>Actions </th>
                    </thead>
                ...
                <div> Total Records: <span id="total-records"></span></div>
            </div>
        </div>
        <!-- footer -->
        <div class="end">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-secondary font-weight-bold" id="acceptrequestmodalLabel">Service Details</h5>
      ...
      <div class="modal-footer">
          <button class="btn btn-success mr-2" style="border-radius : 20px;" id="save-btn">Accept</button>
      </div>
    </div>
  </div>
</div>

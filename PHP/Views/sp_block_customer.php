...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/block_customer.css">
...
<?php 
   ...
   include("./includes/sp-ajax/sp-block-customer-ajax.php");
                ...
                <div class="card" id="card">
                    <div class="card-text">
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="sp_block_customer.php">Block Customer</a>
                          </nav>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 col-6">
              <div class="row mt-5 mr-3" id="customer-details">
